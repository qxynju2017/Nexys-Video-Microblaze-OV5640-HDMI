...
HD_PWD='E:/FPGA_Test/3_Study/nexys_video_microblaze_ov5640_20200321/project_1/project_1.runs/design_1_HDMI_FPGA_ML_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_HDMI_FPGA_ML_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_HDMI_FPGA_ML_0_0.tcl

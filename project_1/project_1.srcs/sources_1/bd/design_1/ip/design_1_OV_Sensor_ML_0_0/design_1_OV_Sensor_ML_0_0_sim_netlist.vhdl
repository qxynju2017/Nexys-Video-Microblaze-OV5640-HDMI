...
--               e:/FPGA_Test/3_Study/nexys_video_microblaze_ov5640_20200321/project_1/project_1.srcs/sources_1/bd/design_1/ip/design_1_OV_Sensor_ML_0_0/design_1_OV_Sensor_ML_0_0_sim_netlist.vhdl
...
entity design_1_OV_Sensor_ML_0_0_cmos_decode is
  port (
    rgb_o : out STD_LOGIC_VECTOR ( 15 downto 0 );
    hs_o : out STD_LOGIC;
    vs_o : out STD_LOGIC;
    vid_clk_ce : out STD_LOGIC;
    \cnt_reg[18]\ : in STD_LOGIC;
    CLK_i : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_OV_Sensor_ML_0_0_cmos_decode : entity is "cmos_decode";
end design_1_OV_Sensor_ML_0_0_cmos_decode;

architecture STRUCTURE of design_1_OV_Sensor_ML_0_0_cmos_decode is
  ...
  attribute SOFT_HLUTNM of \cmos_data_d0[0]_i_1\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \cmos_data_d0[6]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \cmos_fps[3]_i_5\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \rgb565_o[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rgb565_o[10]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rgb565_o[11]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rgb565_o[12]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rgb565_o[13]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rgb565_o[14]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rgb565_o[15]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rgb565_o[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rgb565_o[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rgb565_o[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rgb565_o[4]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \rgb565_o[7]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rgb565_o[8]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of vid_clk_ce_INST_0 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of vs_o_INST_0 : label is "soft_lutpair13";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_OV_Sensor_ML_0_0_count_reset_v1 is
  port (
    \rst_n_reg_reg[4]\ : out STD_LOGIC;
    CLK_i : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_OV_Sensor_ML_0_0_count_reset_v1 : entity is "count_reset_v1";
end design_1_OV_Sensor_ML_0_0_count_reset_v1;

architecture STRUCTURE of design_1_OV_Sensor_ML_0_0_count_reset_v1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_OV_Sensor_ML_0_0_OV_Sensor_ML is
  port (
    rgb_o : out STD_LOGIC_VECTOR ( 15 downto 0 );
    hs_o : out STD_LOGIC;
    vs_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_OV_Sensor_ML_0_0_OV_Sensor_ML : entity is "OV_Sensor_ML";
end design_1_OV_Sensor_ML_0_0_OV_Sensor_ML;

architecture STRUCTURE of design_1_OV_Sensor_ML_0_0_OV_Sensor_ML is
...
cmos_decode_u0: entity work.design_1_OV_Sensor_ML_0_0_cmos_decode
     port map (
      CLK_i => CLK_i,
      D(0) => cmos_vsync_r,
...
nolabel_line70: entity work.design_1_OV_Sensor_ML_0_0_count_reset_v1
     port map (
      CLK_i => CLK_i,
...
entity design_1_OV_Sensor_ML_0_0 is
  ...
  attribute NotValidForBitStream of design_1_OV_Sensor_ML_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_OV_Sensor_ML_0_0 : entity is "design_1_OV_Sensor_ML_0_0,OV_Sensor_ML,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_OV_Sensor_ML_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_OV_Sensor_ML_0_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_OV_Sensor_ML_0_0 : entity is "OV_Sensor_ML,Vivado 2018.2";
end design_1_OV_Sensor_ML_0_0;

architecture STRUCTURE of design_1_OV_Sensor_ML_0_0 is
...
inst: entity work.design_1_OV_Sensor_ML_0_0_OV_Sensor_ML
     port map (
      CLK_i => \^clk_i\,
